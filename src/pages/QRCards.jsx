      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 mb-6">
            ...
            <span className="text-xs text-white/50 tracking-widest uppercase">Collectible Cards</span>
          </div>
          ...
          <p className="text-white/40 max-w-xl mx-auto text-sm sm:text-base">
            Print these cards and scan them with the HANES app to unlock immersive 3D views 
            of Welsh heritage locations
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-16">
          {[
            { step: "01", title: "Print the Card", desc: "Download and print any QR card on standard paper or card stock" },
            { step: "02", title: "Scan with HANES", desc: "Open the HANES app and point your camera at the QR code" },
            { step: "03", title: "Explore in AR", desc: "Watch the location come alive in 3D right on your table" },
          ].map((item, idx) => (
        ...
        {isLoading ? (
          ...
          <div className="text-center py-32">
            ...
            <p className="text-white/30 text-sm">No locations available for QR cards yet</p>
          </div>
        ) : (
