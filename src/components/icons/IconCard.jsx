      ...
      >
        <div className="aspect-[4/3] relative overflow-hidden">
          {icon.image_url ? (
            ...
            >
              <Swords className="w-12 h-12" style={{ color: "rgba(212,168,67,0.30)" }} />
            </div>
          )}
        ...
        <div className="p-5">
          <div className="flex items-center justify-between mb-2">
            <span className="text-[10px] tracking-[0.2em] uppercase font-medium" style={{ color: "var(--hanes-gold)" }}>
              {lang === "cy" ? (icon.era_cy || icon.era || t.common.unknownEra) : (icon.era || t.common.unknownEra)}
            </span>
            <span className="text-[10px]" style={{ color: "var(--app-text-subtle)" }}>{icon.era_years}</span>
          </div>
          <h3 className="text-lg font-semibold mb-1 transition-colors" style={{ color: "var(--app-text)" }}>
            {icon.name}
          </h3>
          <p className="text-xs mb-3" style={{ color: "var(--app-text-subtle)" }}>
            {lang === "cy" ? (icon.title_cy || icon.title) : icon.title}
          </p>
          ...
          <div className="flex items-center gap-1 mt-4 text-xs transition-colors" style={{ color: "rgba(212,168,67,0.75)" }}>
